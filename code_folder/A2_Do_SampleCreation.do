...
* * * * * * * * * 
gen pat_75pernonusa_invt_any =0
replace pat_75pernonusa_invt_any = 1 if non_us_invt_75per > 0 & non_us_invt_75per !=. & patentaward == 1 

gen pat_75pernonusa_invt_mix =0 
replace pat_75pernonusa_invt_mix = 1 if non_us_invt_75per<npatents  & non_us_invt_75per >0 & majority_nonusa_invt !=. & npatents > 1 


gen pat_75pernonusa_invt_none =0
replace pat_75pernonusa_invt_none = 1 if non_us_invt_75per == 0 & non_us_invt_75per !=. & patentaward == 1 
* * * * * * * * * 

* * * * * * * * * 
gen pat_67pernonusa_invt_any =0
replace pat_67pernonusa_invt_any = 1 if non_us_invt_67per > 0 & non_us_invt_67per !=. & patentaward == 1 

gen pat_67pernonusa_invt_mix =0 
replace pat_67pernonusa_invt_mix = 1 if non_us_invt_67per<npatents  & non_us_invt_67per >0 & majority_nonusa_invt !=. & npatents > 1 


gen pat_67pernonusa_invt_none =0
replace pat_67pernonusa_invt_none = 1 if non_us_invt_67per == 0 & non_us_invt_67per !=. & patentaward == 1 
* * * * * * * * * 



sum pat_75pernonusa_invt_any pat_75pernonusa_invt_mix pat_75pernonusa_invt_none pat_67pernonusa_invt_any pat_67pernonusa_invt_mix pat_67pernonusa_invt_none
...
* * * * * * * * * 
gen patent_multiteam_any =0
replace patent_multiteam_any = 1 if multi_invt_team>0 & multi_invt_team !=. & patentaward == 1 

gen pat_multiteam_mix =0 
replace pat_multiteam_mix = 1 if multi_invt_team<npatents  & multi_invt_team >0 & multi_invt_team !=. & npatents > 1 

gen patent_multiteam_none =0
replace patent_multiteam_none = 1 if multi_invt_team <=0 & multi_invt_team !=. & patentaward == 1 
* * * * * * * * * 


sum pat_atonenonus_invt_any pat_allnonusa_invt_any pat_majornonusa_invt_any pat_atonenonus_invt_none pat_allnonusa_invt_none patent_largeteam_any patent_largeteam_none patent_largeteam_topq_any patent_largeteam_topq_none patent_multiteam_none patent_multiteam_any if patentaward == 1 
