...
filename =os.path.join(wrd,"Data\patent_science_python_topq_fullSample.dta")
print(filename)
...
#Save 
filename_save =os.path.join(wrd,"Data\Multipatent_fromPython_topq_fullSample.dta")
print(filename_save)
