...
keep permno_adj patent_date patent_num total_person_id us_count non_us_count majority_nonusa_invt all_nonusa_invt at_least_one_non_us large_invt_team large_invt_team_topq grant_year

preserve
collapse (mean) at_least_one_non_us all_nonusa_invt majority_nonusa_invt, by(grant_year)
...
collapse (sum) patent_count at_least_one_non_us all_nonusa_invt majority_nonusa_invt large_invt_team large_invt_team_topq,by(permno_adj granteddate)
