...
********** drop the old varaibles and reassign new names (using median)

drop patents_topq_cscience_none patents_topq_cscience_any patents_topq_cscience_mixed


gen patents_topq_cscience_none = patents_cscience_adj_none

gen patents_topq_cscience_any = patents_cscience_adj_any

gen patents_topq_cscience_mixed = patents_cscience_adj_mixed
...
save "Data\appendix\patent_science_python_topq_fullSample.dta", replace
...
shell "C:\Users\jayho\anaconda3\python.exe" "code\RnR_1\RnR_Appendix_Tables\py_A3_Kpss_Estimation_SciNoSci_appendix.py" 
...
preserve
clear all
use "Data\appendix\Multipatent_fromPython_topq_fullSample.dta" 
...
save "Data\appendix\Multipatent_fromPython_topq_fullSample2_v2.dta",replace
restore


merge 1:1 permno_adj date using "Data\appendix\Multipatent_fromPython_topq_fullSample2_v2.dta",keepusing(science_new non_science_new patents_topq_cscience_mixed)
...
gen patent_value_science_m_noadj = economic_value_science

gen patent_value_science_median =economic_value_science_only
gen patent_value_nonscience_median =economic_value_nonscience_only


gen patents_cscience_adj_none=  patents_topq_cscience_none 

gen patents_cscience_adj_any  = patents_topq_cscience_any

gen patents_cscience_adj_mixed  = patents_topq_cscience_mixed


keep permno_adj date bdate patents_cscience_adj_any patents_cscience_adj_none patents_cscience_adj_mixed npatents patent_value_kogan_fs patent_value_science_m_noadj patent_value_science_median patent_value_nonscience_median
...
label var patent_value_science_m_noadj "Pat Val: SciNoSci (median) (No Adj.)"
label var patent_value_science_median "Pat Val: Sci (median) (Adj.)"
label var patent_value_nonscience_median "Pat Val: NoSci (median) (Adj.)"

save "Data\appendix\patent_Value_median_fullSample.dta", replace
